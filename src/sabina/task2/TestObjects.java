...
public class TestObjects {
    public static void main(String[] args) {
        ...
        Manager manager = new Manager(" Kelly", 33, 1234567898L, "34993 Woods Crossing Rd, California, Missouri(MO), 65018", 130000, "Customer Relationship Management");
        ...
        System.out.println(manager); //Manager{name=' Kelly', age=33, phoneNumber=1234567898, address='34993 Woods Crossing Rd, California, Missouri(MO), 65018', salary=130000.0, specialization=Customer Relationship Management}
